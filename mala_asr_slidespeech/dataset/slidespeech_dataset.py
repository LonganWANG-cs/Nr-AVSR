...
class SlidespeechDataset(Dataset):
    def __init__(self, dataset_config, tokenizer=None, split='train',):
        ...
        self.noise_rate=dataset_config.noise_rate
        if split == "train":
            ...
            if self.noise_rate==0.2:
                with open(dataset_config.train_scp_file_path + "text_noisy_20",'r') as f:
                    for line in f:
                ...
                with open(dataset_config.train_scp_file_path + "text_noisy_50",'r') as f:
                    for line in f:
                        line = line.strip().split(' ',1)
                        if len(line) == 1:
                            self.label_list.append(None)
                            ...
                            if dataset_config.lower:
                                ...
                                self.label_list.append(line[1])
            elif self.noise_rate==0.8:
                 with open(dataset_config.train_scp_file_path + "text_noisy_80",'r') as f:
                    for line in f:
                        line = line.strip().split(' ',1)
                        if len(line) == 1:
                            self.label_list.append(None)
